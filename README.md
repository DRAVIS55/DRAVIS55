...
![Completed](https://img.shields.io/badge/Jan%202026%20–%20May%202026-9B5C5A?style=flat-square&labelColor=F9EAE8&color=9B5C5A)
![Contract](https://img.shields.io/badge/Contract-9B5C5A?style=flat-square&labelColor=F9EAE8&color=9B5C5A)
![Nairobi](https://img.shields.io/badge/Nairobi%20·%20Remote-9B5C5A?style=flat-square&labelColor=F9EAE8&color=9B5C5A)
...
| [🧠 Ubuntu News Intelligence](https://github.com/DRAVIS55/Ubuntu-News-Intelligence) | African news intelligence · RAG · semantic search · knowledge graphs · trend detection | Python · NLP · RAG | ![Live](https://img.shields.io/badge/Live-C0392B?style=flat-square&labelColor=F9EAE8&color=C0392B) |
...
| [💱 Java Currency Converter](https://github.com/DRAVIS55/Java-Currency-Converter) | Real-time converter · **54% forecasting accuracy** via ML and live financial APIs | Java · ML · Finance APIs | ![Live](https://img.shields.io/badge/Live-C0392B?style=flat-square&labelColor=F9EAE8&color=C0392B) |
| [🏦 SACCO Management System](https://github.com/DRAVIS55/django-react-sacco-system) | Loan processing · repayment tracking · automated reminders · real-time analytics | Django · MySQL · React | ![Live](https://img.shields.io/badge/Live-C0392B?style=flat-square&labelColor=F9EAE8&color=C0392B) |
...
| Project | Description | Stack | Status |
|:---|:---|:---|:---:|
| [🛡️ Network Security Lab](https://github.com/DRAVIS55/netsec-multivector-demo) | ARP · DNS · DHCP · ICMP · HTTP-layer attack simulations for controlled security training | C · Shell | ![Live](https://img.shields.io/badge/Live-C0392B?style=flat-square&labelColor=F9EAE8&color=C0392B) |
| [🏥 AI Patient Triage](https://github.com/DRAVIS55/Care_me_AI_model_V1) | Predicts emergency urgency levels · reduces misclassification in healthcare response | Python · ML | ![Live](https://img.shields.io/badge/Live-C0392B?style=flat-square&labelColor=F9EAE8&color=C0392B) |
...
```
▸  200×  API speed improvement  ──  1000ms → 5ms (Chuka Timetabling System)
▸   0%   timetable conflicts    ──  AI constraint-based scheduling engine
▸  <10s  scheduling time        ──  down from 3–5 hours, university-wide
▸   4    donation channels      ──  M-Pesa · PayPal · Card · Sui Blockchain
▸  54%   ML forecasting acc.    ──  Java Currency Converter (live financial APIs)
▸   7+   client platforms       ──  delivered across hospitality, automotive, tech & NGO
```
